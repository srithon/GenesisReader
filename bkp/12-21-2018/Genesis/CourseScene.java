...
public class CourseScene extends Scene
{
	...
	public CourseScene(VBox layout, int d1, int d2, Course course)
	{
		...
		table.getColumns().addAll(assignmentCategoryCol, assignmentNameCol, assignmentDueDateCol, assignmentMarkingPeriodCol, assignmentWeightingCol, assignmentUnweightedPointsCol, assignmentWeightedPointsCol, assignmentPercentageCol);
