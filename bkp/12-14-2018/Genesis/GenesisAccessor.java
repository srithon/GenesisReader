...
public class GenesisAccessor
{
	...
	public GenesisAccessor(String usr, String pass, boolean fast, boolean time, String markingPeriod)
	{
		if (time)
		{
	...
	public String[] splitAssignmentName(String[] splitArray)
	{
		String[] commonCategories = {"participation", "quizzes", "tests", "homework", "classwork",
				"pre-test", "post-test", "pre test", "post test", "socratic seminar"};
		int splitIndex = 1;
